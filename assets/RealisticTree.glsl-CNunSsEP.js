import{i5 as $e,V as x,di as k,cR as Oe,jX as et,eo as Bt,eZ as Ht,h_ as Wt,fy as L,hQ as kt,pv as Ut,jJ as Yt,x3 as tt,z as c,A as H,B as at,x4 as Zt,x5 as qt,k3 as Q,cD as ot,k2 as Fe,hY as Ge,hO as Xt,lf as Jt,x6 as U,_ as he,gN as rt,jI as ne,bJ as re,d_ as Kt,e0 as Qt,q as ea,aN as ta,jf as aa,eH as oa,d4 as z,f3 as ra,ic as ia,dk as na,cP as sa,d9 as la,ex as we,ey as ca,eG as je,d5 as da,hM as ua}from"./index-CKfPgHC1.js";import{ab as P,i as me,d as pe,aX as I,a as it,aY as fe,aZ as nt,a_ as st,a$ as ha,b0 as W,b1 as ma,b2 as pa,ad as fa,f as va,b3 as J,r as N,a2 as ae,D as A,E as D,b4 as G,G as K,b as y,I as j,al as ga,H as xa,b5 as ba,b6 as lt,q as se,aj as ct,o as dt,aU as ut,g as wa,j as Ne,k as ve,s as ht,b7 as ya,aH as Ma,u as Ta,v as Be,ah as _a,aa as _,aF as Ie,ag as Sa,b8 as Ca,c as ee,b9 as za,X as oe,ba as $a,M as Oa,bb as mt,a9 as le,F as pt,L as ft,K as vt,bc as gt,J as xt,N as Fa,T as Na,O as Ia,P as Va,Q as La,R as Pa,U as Ea,V as Ra,W as Aa,Y as Da,x as m,A as Ga,bd as ye,be as Me,a1 as ja,aq as Ba,B as Ha,aS as Wa,a3 as ka,az as Ua}from"./OutputColorHighlightOID.glsl-B_HHfjWt.js";import{t as ze,Q as Ve}from"./InterleavedLayout-t5zWA7bh.js";import{s as S,T as bt,g as ce,I as He}from"./BufferView-CfIqYlvJ.js";import{r as Ya}from"./VertexBuffer-CXx8MtEz.js";import{g as Za}from"./plane-D08hPH36.js";import{T as Le,d as Pe,_ as qa}from"./renderState-CKc66y4x.js";import{t as Xa}from"./VertexAttributeLocations-BfZbt_DV.js";import{t as i,n as p}from"./glsl-B5bJgrnA.js";import{s as ge}from"./ShaderBuilder-CVyryOo7.js";function xe(a,e){switch(a.fragment.code.add(i`vec3 screenDerivativeNormal(vec3 positionView) {
...
return color;
}`)}const Ue=k();function _t(a,e){const{hasModelTransformation:t,instancedDoublePrecision:o,instanced:r,output:s,hasVertexTangents:d}=e;t&&(a.vertex.uniforms.add(new ha("model",l=>l.modelTransformation??Ge)),a.vertex.uniforms.add(new I("normalLocalOriginFromModel",l=>(Xt(Ue,l.modelTransformation??Ge),Ue)))),r&&o&&(a.attributes.add("instanceModelOriginHi","vec3"),a.attributes.add("instanceModelOriginLo","vec3"),a.attributes.add("instanceModel","mat3"),a.attributes.add("instanceModelNormal","mat3"));const n=a.vertex;o&&(n.include(Ja,e),n.uniforms.add(new W("viewOriginHi",l=>ma(L(ie,l.camera.viewInverseTransposeMatrix[3],l.camera.viewInverseTransposeMatrix[7],l.camera.viewInverseTransposeMatrix[11]),ie)),new W("viewOriginLo",l=>pa(L(ie,l.camera.viewInverseTransposeMatrix[3],l.camera.viewInverseTransposeMatrix[7],l.camera.viewInverseTransposeMatrix[11]),ie)))),n.code.add(i`
...
forwardTextureCoordinates();`),a.include(B,e),o.main.add(i`
        ...
        ${p(n,i`vec4 texColor = texture(tex, ${f?"colorUV":"vuv0"});
                discardOrAdjustAlpha(texColor);`)}`);break;case 4:case 5:case 6:case 7:case 10:A(t,e),a.include(D),a.include(G,e),a.include(K,e),a.include(po,e),o.include(j,e),a.include(xa,e),ba(a),r.add("depth","float",{invariant:!0}),n&&o.uniforms.add(new y("tex",v=>v.texture)),t.main.add(i`vpos = getVertexInLocalOriginSpace();
vpos = subtractOrigin(vpos);
vpos = addVerticalOffset(vpos, localOrigin);
...
vpos = addVerticalOffset(vpos, localOrigin);
gl_Position = transformPosition(proj, view, vpos);
forwardTextureCoordinates();`),o.include(j,e),a.include(B,e),a.include(ga,e),o.main.add(i`
        discardBySlice(vpos);
        ${p(n,i`vec4 texColor = texture(tex, ${f?"colorUV":"vuv0"});
                discardOrAdjustAlpha(texColor);`)}
...
}`);break;default:$e(e.doubleSidedMode);case 3:}}function Ft(a,e){const t=e.pbrMode,o=a.fragment;if(t!==2&&t!==0&&t!==1)return void o.code.add(i`void applyPBRFactors() {}`);if(t===0)return void o.code.add(i`void applyPBRFactors() {}
...
}`)):a.vertex.code.add(i`void forwardMetallicRoughnessUV(){}`)}function Pt(a){a.include(Oa),a.code.add(i`
...
return mix(mrr, vec3(0.0, 1.0, 0.04), snow);
}`))}function Rt(a){const e=new ge,{attributes:t,vertex:o,fragment:r,varyings:s}=e,{output:d,normalType:n,offsetBackfaces:l,spherical:u,snowCover:f,pbrMode:v,textureAlphaPremultiplied:M,instancedDoublePrecision:C,hasVertexColors:g,hasVertexTangents:O,hasColorTexture:F,hasNormalTexture:Y,hasNormalTextureTransform:E,hasColorTextureTransform:R}=a;if(A(o,a),t.add("position","vec3"),s.add("vpos","vec3",{invariant:!0}),e.include(K,a),e.include(_t,a),e.include(mt,a),e.include(Go,a),!oe(d))return e.include(Ct,a),e;e.include(jo,a),e.include(Bo,a),e.include(Ho,a),e.include(Wo,a),le(o,a),e.include(xe,a),e.include(D);const V=n===0||n===1;return V&&l&&e.include(Mt),e.include(vo,a),e.include(wt,a),e.include(Tt,a),s.add("vPositionLocal","vec3"),e.include(G,a),e.include(St,a),e.include(pt,a),o.uniforms.add(new ft("externalColor",b=>b.externalColor,{supportsNaN:!0})),s.add("vcolorExt","vec4"),e.include(vt,a),o.include(fe),o.include(gt),e.include(C?It:Vt,a),o.main.add(i`
    ...
    vpos = addVerticalOffset(vpos, localOrigin);
    ${p(O,"vTangent = dpTransformVertexTangent(tangent);")}
    gl_Position = transformPosition(proj, view, vpos);
  ...
  `),e.include(Ot,a),r.include(Ee,a),e.include(B,a),r.include(j,a),e.include(xt,a),le(r,a),r.uniforms.add(o.uniforms.get("localOrigin"),new ee("ambient",b=>b.ambient),new ee("diffuse",b=>b.diffuse),new N("opacity",b=>b.opacity),new N("layerOpacity",b=>b.layerOpacity)),F&&r.uniforms.add(new y("tex",b=>b.texture)),e.include(Ft,a),r.include(Re,a),r.include(Pt),e.include(No,a),r.include(Et,a),Ae(r),De(r),te(r),r.main.add(i`
    discardBySlice(vpos);
    ...
    ${Y?`mat3 tangentSpace = computeTangentSpace(${O?"normal":"normal, vpos, vuv0"});
  ...
  `);const{hasColorTexture:M,hasColorTextureTransform:C}=a;return e.include(Ot,a),r.include(Ee,a),e.include(B,a),r.include(j,a),e.include(xt,a),le(r,a),ue(r),Ae(r),De(r),r.uniforms.add(o.uniforms.get("localOrigin"),o.uniforms.get("view"),new ee("ambient",g=>g.ambient),new ee("diffuse",g=>g.diffuse),new N("opacity",g=>g.opacity),new N("layerOpacity",g=>g.layerOpacity)),M&&r.uniforms.add(new y("tex",g=>g.texture)),e.include(Ft,a),r.include(Re,a),r.include(Pt),r.include(Et,a),te(r),r.main.add(i`
      discardBySlice(vpos);
      discardByTerrainDepth();
